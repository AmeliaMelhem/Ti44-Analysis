...
# ================================= Z = 0.002 ================================
aa_wd1min_pts_0002 = np.array(aa_df.loc[:,['He_min_wd1(Msun)_0002','Mwd1(Msun)']])
aa_wd1max_pts_0002 = np.array(aa_df.loc[:,['He_max_wd1(Msun)_0002','Mwd1(Msun)']])
aa_wd2min_pts_0002 = np.array(aa_df.loc[:,['He_min_wd2(Msun)_0002','Mwd2(Msun)']])
aa_wd2max_pts_0002 = np.array(aa_df.loc[:,['He_max_wd2(Msun)_0002','Mwd2(Msun)']])

ag_wd1min_pts_0002 = np.array(ag_df.loc[:,['He_min_wd1(Msun)_0002','Mwd1(Msun)']])
ag_wd1max_pts_0002 = np.array(ag_df.loc[:,['He_max_wd1(Msun)_0002','Mwd1(Msun)']])
ag_wd2min_pts_0002 = np.array(ag_df.loc[:,['He_min_wd2(Msun)_0002','Mwd2(Msun)']])
ag_wd2max_pts_0002 = np.array(ag_df.loc[:,['He_max_wd2(Msun)_0002','Mwd2(Msun)']])

# ================================= Z = 0.01 =================================
aa_wd1min_pts_01 = np.array(aa_df.loc[:,['He_min_wd1(Msun)_01','Mwd1(Msun)']])
aa_wd1max_pts_01 = np.array(aa_df.loc[:,['He_max_wd1(Msun)_01','Mwd1(Msun)']])
aa_wd2min_pts_01 = np.array(aa_df.loc[:,['He_min_wd2(Msun)_01','Mwd2(Msun)']])
aa_wd2max_pts_01 = np.array(aa_df.loc[:,['He_max_wd2(Msun)_01','Mwd2(Msun)']])

ag_wd1min_pts_01 = np.array(ag_df.loc[:,['He_min_wd1(Msun)_01','Mwd1(Msun)']])
ag_wd1max_pts_01 = np.array(ag_df.loc[:,['He_max_wd1(Msun)_01','Mwd1(Msun)']])
ag_wd2min_pts_01 = np.array(ag_df.loc[:,['He_min_wd2(Msun)_01','Mwd2(Msun)']])
ag_wd2max_pts_01 = np.array(ag_df.loc[:,['He_max_wd2(Msun)_01','Mwd2(Msun)']])

# ================================= Z = 0.02 =================================
aa_wd1min_pts_02 = np.array(aa_df.loc[:,['He_min_wd1(Msun)_02','Mwd1(Msun)']])
aa_wd1max_pts_02 = np.array(aa_df.loc[:,['He_max_wd1(Msun)_02','Mwd1(Msun)']])
aa_wd2min_pts_02 = np.array(aa_df.loc[:,['He_min_wd2(Msun)_02','Mwd2(Msun)']])
aa_wd2max_pts_02 = np.array(aa_df.loc[:,['He_max_wd2(Msun)_02','Mwd2(Msun)']])

ag_wd1min_pts_02 = np.array(ag_df.loc[:,['He_min_wd1(Msun)_02','Mwd1(Msun)']])
ag_wd1max_pts_02 = np.array(ag_df.loc[:,['He_max_wd1(Msun)_02','Mwd1(Msun)']])
ag_wd2min_pts_02 = np.array(ag_df.loc[:,['He_min_wd2(Msun)_02','Mwd2(Msun)']])
ag_wd2max_pts_02 = np.array(ag_df.loc[:,['He_max_wd2(Msun)_02','Mwd2(Msun)']])
...
"""
aa_ti_max_0002 =  np.array(ti_interp.arr_interp(aa_wd1max_pts_0002)) 
aa_ti_max_0002 += np.array(ti_interp.arr_interp(aa_wd2max_pts_0002)) 
aa_ti_min_0002 =  np.array(ti_interp.arr_interp(aa_wd1min_pts_0002)) 
aa_ti_min_0002 += np.array(ti_interp.arr_interp(aa_wd2min_pts_0002)) 

ag_ti_max_0002 =  np.array(ti_interp.arr_interp(ag_wd1max_pts_0002)) 
ag_ti_max_0002 += np.array(ti_interp.arr_interp(ag_wd2max_pts_0002)) 
ag_ti_min_0002 =  np.array(ti_interp.arr_interp(ag_wd1min_pts_0002)) 
ag_ti_min_0002 += np.array(ti_interp.arr_interp(ag_wd2min_pts_0002)) 


aa_ti_max_01 =  np.array(ti_interp.arr_interp(aa_wd1max_pts_01)) 
aa_ti_max_01 += np.array(ti_interp.arr_interp(aa_wd2max_pts_01)) 
aa_ti_min_01 =  np.array(ti_interp.arr_interp(aa_wd1min_pts_01)) 
aa_ti_min_01 += np.array(ti_interp.arr_interp(aa_wd2min_pts_01)) 

ag_ti_max_01 =  np.array(ti_interp.arr_interp(ag_wd1max_pts_01)) 
ag_ti_max_01 += np.array(ti_interp.arr_interp(ag_wd2max_pts_01)) 
ag_ti_min_01 =  np.array(ti_interp.arr_interp(ag_wd1min_pts_01)) 
ag_ti_min_01 += np.array(ti_interp.arr_interp(ag_wd2min_pts_01)) 


aa_ti_max_02 =  np.array(ti_interp.arr_interp(aa_wd1max_pts_02)) 
aa_ti_max_02 += np.array(ti_interp.arr_interp(aa_wd2max_pts_02)) 
aa_ti_min_02 =  np.array(ti_interp.arr_interp(aa_wd1min_pts_02)) 
aa_ti_min_02 += np.array(ti_interp.arr_interp(aa_wd2min_pts_02)) 

ag_ti_max_02 =  np.array(ti_interp.arr_interp(ag_wd1max_pts_02)) 
ag_ti_max_02 += np.array(ti_interp.arr_interp(ag_wd2max_pts_02)) 
ag_ti_min_02 =  np.array(ti_interp.arr_interp(ag_wd1min_pts_02)) 
ag_ti_min_02 += np.array(ti_interp.arr_interp(ag_wd2min_pts_02)) 
